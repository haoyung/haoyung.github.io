...
subhead: "本週是一年一度的台大咖啡週，我們會在校園內擺攤。<br>今年我們準備了 9 支來自 SEY 的咖啡，並以低於市價的方式分享給大家，有空的話歡迎來找我們喝杯咖啡！<br>這次我們也開始使用一個全新的低擾動 KONO 參數，文末會有詳細的沖煮流程供各位參考。"
tag: [台大咖啡社]
category: articles
---
...
- 佈水器：[Tricolate](https://tricolate.com/)
    ...
    - <div class="row justify-content-center">
            <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
                <img src="{{ site.github.url }}/assets/img/disperser_on_kono.webp" alt="" class="img-fluid responsive-image" style="border:1px black solid;">
