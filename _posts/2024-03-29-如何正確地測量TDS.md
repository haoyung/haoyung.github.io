...
<div class="row mt-md-4 mt-3 mb-md-4 mb-3 justify-content-center text-center">
    <div class="col-md-12">
        ...
        <span class="image-span">進行蒸發量實驗的沖煮<br>使用的是似乎還沒有在本部落格出現過的器材 tricolate<br>沖煮的是 <a href="https://www.seycoffee.com/products/2023-jorge-cortes-chiquito-colombia">SEY 的一支哥倫比亞水洗 Tabi</a></span>
    </div>
</div>

沖煮完成後我立刻進行取樣，其中未加蓋的實驗組（No Lid）與對照組各取 5 個 5ml 的樣本。對照組的取樣手法與上一章相同，但在實驗組中 5ml 的樣品則會被放在未加蓋的小杯子中，而經過半小時的冷卻後我會再以上一章的測量手法對兩個樣品進行測量。

以下是總共 10 個樣本的 TDS 測量結果，以及根據 TDS 數值計算出的萃取率。
