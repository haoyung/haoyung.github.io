...
<div class="row justify-content-center">
    <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
        ...
        <span class="image-span">圖一（尚未墊入任何不銹鋼箔）</span>
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
        ...
        <span class="image-span">圖二（左上、左下及右邊的螺絲下分別墊入了 7 片、0 片、0 片不銹鋼箔）</span>
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
        ...
        <span class="image-span">圖三（左上、左下及右邊的螺絲下分別墊入了 13 片、0 片、6 片不銹鋼箔）</span>
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
        ...
        <span class="image-span">圖四（左上、左下及右邊的螺絲下分別墊入了 16 片、0 片、9 片不銹鋼箔）</span>
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
        <img src="{{ site.github.url }}/assets/img/alignment-8.webp" alt="" class="img-fluid responsive-image">
        <span class="image-span">圖五（左上、左下及右邊的螺絲下分別墊入了 16 片、0 片、10 片不銹鋼箔）</span>
    </div>
</div>
