...
<div class="row justify-content-center">
    <div class="col-md-6 text-center">
        ...
        <span style="font-size: 0.70em; color: var(--img-text-color)">翡翠莊園的紅標</span>
    </div>
</div>
...
<div class="row g-md-3 g-3 mt-md-0">
    <div class="col-md-4 mt-md-0">
        <img src="{{ site.github.url }}/assets/img/蜜處理.png" style="border:1px #212529 solid;" width="100%">
    </div>
    <div class="col-md-4 mt-md-0">
        <img src="{{ site.github.url }}/assets/img/日曬.png" style="border:1px #212529 solid;" width="100%">
    </div>
    <div class="col-md-4 mt-md-0">
        <img src="{{ site.github.url }}/assets/img/特殊酵母.png" style="border:1px #212529 solid;" width="100%">
    </div>
</div>
