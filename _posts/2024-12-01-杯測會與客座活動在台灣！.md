...
<div class="row">
    <div class="col-md-6 text-center">
        <img src="{{ site.github.url }}/assets/images/{{ page.imgfolder }}/tw-events.webp" style="width: 100%; border:1px black solid;">
    </div>
</div>

<div class="row">
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img src="{{ site.github.url }}/assets/images/{{ page.imgfolder }}/pop-up.webp" style="width: 100%; border:1px black solid;">
    </div>
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img src="{{ site.github.url }}/assets/images/{{ page.imgfolder }}/cupping-sessions.webp" style="width: 100%; border:1px black solid;">
    </div>
