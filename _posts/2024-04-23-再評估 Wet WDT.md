...
8.   兩組使用不同的手法進行悶蒸：
     -   Wet WDT：使用 WDT 工具（我使用的是 Barista Hustle Tools 的 [the Comb](https://baristahustletools.com/products/the-comb)）進行 deep Wet WDT，也就是有攪動到粉層底部的 Wet WDT，可參考下方的影片。
