...
<div class="row g-md-5 g-3">
    <div class="col-md-6">
        <div class="flex-column mt-md-4">
            <img src="{{ site.github.url }}/assets/img/sudanrume.png" border="1" border-color="gray" alt="papayatypic" width="100%">
        </div>
    </div>
    <div class="col-md-6">
        <div class="flex-column mt-md-4">
            <img src="{{ site.github.url }}/assets/img/logo.png" border="1" border-color="gray" alt="papayatypic" width="100%">
        </div>
    </div>
</div>
