...
>   Note: [The IG account for this blog](https://instagram.com/whycoffee.blog)<sup class="footnote-sup">[A]</sup>is now live! Future shorter reviews and reflection will be posted there. Please follow!
...
Low agitation and high extraction seem to be conflicting concepts. Agitation (which is essentially stirring, including the agitation of coffee grounds by the water flow) can help the coffee grounds mix thoroughly with water, [increasing extraction and making it more even in most cases](https://www.instagram.com/p/CygUKuNLw94/?img_index=2).

However, agitation also accelerates fines migration (usually referring to the settling of fines), making the dripper more prone to clogging. Clogging can exacerbate channeling and bypass, ultimately leading to more bitter substances not being properly filtered by the coffee bed. This is why we usually associate clogging with unpleasant flavors like bitterness<sup class="footnote-sup">[B]</sup>.
...
I have always enjoyed high-extraction coffee, and usually aim for at least 22% extraction when brewing. In my experience, high-extraction coffee has better flavor complexity and sweetness, and tastes closer to cupping. Being able to recreate cupping bowl flavors in pour-over has long been one of my dreams.

But to achieve high extraction rates, finer grinding or the help of agitation is needed.
...
This makes pursuing high-extraction brews often difficult and frustrating, because even when using burrs that produce very few fines (I use the 98mm SSP Brew burrs), clogging cannot be completely avoided with fine grinding and high agitation. In this situation, even if high extraction is achieved, one often has to put up with poorer mouthfeel despite enjoying the high flavor complexity and sweetness. More precisely: astringency.

#### The Inspiration for Low-Agitation Methods

The issue of astringency has been getting more attention in the coffee enthusiast community lately. I've also discussed my problem of overly apparent astringency at high extractions with many international enthusiasts on Discord. But most people don't pursue such high extraction rates, so grinding coarser has become the simplest solution. It not only reduces the amount of fines, making clogging less likely, but also reduces the number of times the coffee is cut. This in turn reduces the astringent substances released from broken cell walls that are difficult to dissolve in water (this is more complex; again, refer to [Jonathan Gagné's article](https://coffeeadastra.com/2022/08/01/the-mechanism-behind-astringency-in-coffee/) if interested).

But I wondered, is there really no way to reduce astringency while maintaining high extraction? The place I know of in the world whose extraction philosophy of "maximizing extraction and recreating cupping flavors" is closest to mine is probably [SEY](https://www.seycoffee.com/). They are a coffee shop I really like located in Brooklyn. I usually brew coffee from them. Out of curiosity, I emailed to ask about their brewing parameters and mentioned my views on astringency.

I didn't actually expect a reply, because past contact experience showed they barely had time to respond to order messages. To my surprise, two days later I received a detailed reply from them (I guess written by the renowned owner Lance?), which said:
...
<div class="row justify-content-center">
    <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
        ...
        <span class="image-span">Grind size illustration<br>This is SEY's Las Perlitas (Washed Colombian Field Blend) ground on 98mm SSP Brew burrs, with a burr gap of 225 µm from lock</span>
    </div>
</div>
...
-   Water: Pure water
    ...
    -   If you have little knowledge of water, you can also just use regular drinking water without TDS that is too high.
-   Grind size: Burr gap between 200 and 300 µm.
...
<div class="footnote">
  ...
  <div class="footnote-content">Many people, myself included, believe that minerals do not participate in extraction, so there is no difference between adding them before or after brewing. Here I choose the more convenient option of adding minerals after brewing. I use <a href="https://lotuscoffeeproducts.com/">Lotus Coffee Brew Water</a>.</div>
</div>
<div class="footnote">
...
-   Very lightly roasted coffee
    ...
    -   Some roasters I've experimented with that have a higher success rate: [SEY](https://www.seycoffee.com/), [Manhattan](https://manhattancoffeeroasters.com/), [Prodigal](https://getprodigal.com/).
-   Dripper
...
-   A dispersion screen that can reduce agitation
    -   The [Melodrip](https://melodrip.co/), [Tricolate](https://tricolate.com/), or the dispersion screen that comes with the [Pulsar](https://nextlevelbrewer.com/pulsar-brewer/) all work. You can actually also use a small spoon to catch the water poured from the gooseneck kettle. Refer to [the method shared by @pocketsciencecoffee](https://www.youtube.com/watch?v=Z7EOCcH0v68). As long as it can reduce agitation to the coffee bed.
-   WDT tool
    -   A spoon, chopstick, glass rod, or other tool that can stir the coffee bed during the bloom can also be used as a substitute.
...
The following steps use an [Orea V3](https://shop.orea.uk/products/orea-brewer-v3-mk2) with [Flat Filters](https://shop.orea.uk/products/orea-flat-paper-filter-type-g), a [negotiator](https://shop.orea.uk/products/negotiator-tool), and the dispersion screen from the [Pulsar](https://nextlevelbrewer.com/pulsar-brewer/) as an example.
...
8.  At 1:00, pour in 70g of water. Start with a slightly larger amount of water so it can distribute evenly in the dispersion screen, then pour in the center at a rate of 2.5-3g/s.
