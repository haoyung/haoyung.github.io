...
<div class="row justify-content-center">
    <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
        <img src="/assets/images/ntu_coffee_week.webp" alt="" class="img-fluid responsive-image-vertical" style="border:1px black solid;">
...
<div class="row justify-content-center">
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img src="/assets/images/ntu_coffee_week_menu_1.png" style="width: 100%; border:1px black solid;">
    </div>
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img src="/assets/images/ntu_coffee_week_menu_2.png" style="width: 100%; border:1px black solid;">
    </div>
</div>

<div class="row justify-content-center">
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img src="/assets/images/ntu_coffee_week_menu_3.png" style="width: 100%; border:1px black solid;">
    </div>
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img src="/assets/images/ntu_coffee_week_menu_4.png" style="width: 100%; border:1px black solid;">
    </div>
</div>
...
- 佈水器：[Tricolate](https://tricolate.com/)
    ...
    <div class="row justify-content-center">
            <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
                <img src="/assets/images/disperser_on_kono.webp" alt="" class="img-fluid responsive-image-vertical">
