...
<div class="row mt-md-5 mt-4 mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img src="/assets/images/{{ page.imgfolder }}/BH_result.webp" alt="" class="img-fluid">
...
<div class="row mt-md-5 mt-4 mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img src="/assets/images/{{ page.imgfolder }}/fig1.webp" alt="" class="img-fluid responsive-plot">
...
<div class="row mt-md-5 mt-4 mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img src="/assets/images/{{ page.imgfolder }}/fig4.webp" alt="" class="img-fluid responsive-plot">
