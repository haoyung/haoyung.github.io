...
Flavor preferences are subjective, and similarly, preferences in coffee are highly subjective, too. However, objective data is still crucial for communication among enthusiasts and for fine-tuning brewing parameters to improve a subpar cup.

In the extraction theory course I teach each semester at NTU Coffee Club, I always begin with the *objective* data of coffee, namely TDS (total dissolved solids, a measure of concentration) and EY (extraction yield).
...
TDS indicates the strength or concentration of coffee. It is defined as the mass of coffee the amount of coffee mass that made it into your beverage $(M_{bev})$ divided by the total beverage weight $(B)$.
