...
<div class="row mt-md-4 mt-3 mb-md-6 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img src="{{ site.github.url }}/assets/img/{{ page.imgfolder }}/evaporation.png" alt="" class="img-fluid">
...
<div class="row mt-md-4 mt-3 mb-md-6 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img src="{{ site.github.url }}/assets/img/{{ page.imgfolder }}/TDS_comparison.webp" alt="" class="img-fluid">
...
<div class="row mt-md-4 mt-3 mb-md-6 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img src="{{ site.github.url }}/assets/img/{{ page.imgfolder }}/TDS_comparison_violin.webp" alt="" class="img-fluid">
...
<div class="row mt-md-4 mt-3 mb-md-6 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img src="{{ site.github.url }}/assets/img/{{ page.imgfolder }}/refractive_index.webp" alt="" class="img-fluid">
...
<div class="row mt-md-4 mt-3 mb-md-6 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img src="{{ site.github.url }}/assets/img/{{ page.imgfolder }}/refractive_index_violin.webp" alt="" class="img-fluid">
