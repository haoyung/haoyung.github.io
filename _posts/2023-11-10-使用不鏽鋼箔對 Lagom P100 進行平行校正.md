...
我們想要在刀盤較低的一側墊入墊片，因此這時我們只要在高點的對側螺絲下墊入墊片，就可以使刀盤變得更為平行，此時只要重複這個動作直到達成 full wipe 即可，這時就代表此片刀盤已經與轉軸平行，接下來只要依照相同方法也校正完另一片刀盤即能確保平行。
...
所以說校正後顆粒度有變得更為均勻嗎？咖啡有變得更好喝嗎？我覺得有，但老實說我也不是這麼有自信，畢竟這很難用數據來證明，而我通常認為僅憑感官經驗並不足以當作證據。
