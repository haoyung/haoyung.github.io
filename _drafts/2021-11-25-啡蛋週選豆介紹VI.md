...
<div class="row g-md-6 g-3 mt-md-0">
    <div class="col-md-6 mt-md-3">
        <img src="/assets/images/BOP.png" style="border:1px black solid;" class="text-img" width="100%">
    </div>
    <div class="col-md-6 mt-md-3">
        <img src="/assets/images/EsmeraldaSpecial.png" style="border:1px black solid;" class="text-img" width="100%">
    </div>
    <div class="col-md-6">
        <img src="/assets/images/PrivateCollection.png" style="border:1px black solid;" class="text-img" width="100%">
    </div>
    <div class="col-md-6">
        <img src="/assets/images/logo.png" style="border:1px black solid;" class="text-img" width="100%">
    </div>
</div>
