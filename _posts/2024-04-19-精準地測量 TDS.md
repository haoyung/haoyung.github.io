...
<div class="row mt-md-5 mt-4 mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <video width="100%" controls playsinline autoplay muted loop>
    		<source src="/assets/images/{{ page.imgfolder }}/RI_calculater.mov" type="video/mp4">
		</video>
...
<div class="row mt-md-5 mt-4 mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img width="2400" height="2400" src="/assets/images/{{ page.imgfolder }}/fig10.webp" alt="testing alt" class="img-fluid responsive-plot">
...
<div class="row mt-md-5 mt-4 mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-6">
        <img width="2400" height="1800" src="/assets/images/{{ page.imgfolder }}/fig11.webp" alt="" class="img-fluid">
    </div>
    <div class="col-md-6 mt-md-0 mt-4">
        <img width="2400" height="1800" src="/assets/images/{{ page.imgfolder }}/fig12.webp" alt="" class="img-fluid">
    </div>
...
<div class="row mt-md-5 mt-4 mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-6">
        <img width="2400" height="1800" src="/assets/images/{{ page.imgfolder }}/fig13.webp" alt="" class="img-fluid">
    </div>
    <div class="col-md-6 mt-md-0 mt-4">
        <img width="2400" height="1800" src="/assets/images/{{ page.imgfolder }}/fig14.webp" alt="" class="img-fluid">
    </div>
...
<div class="row mt-md-5 mt-4 mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <img width="2400" height="3600" src="/assets/images/{{ page.imgfolder }}/fig15.webp" alt="testing alt" class="img-fluid responsive-plot">
