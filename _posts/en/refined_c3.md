...
However, we often need some objective data, not only for communication and exchange among enthusiasts but also to help us adjust parameters and improve a cup of poorly brewed coffee.
...
The vertical axis in the commonly seen SCA's Brewing Control Chart represents the concentration (or TDS).
...
We generally use a refractometer to measure TDS optically. The detailed principle is not complicated, but since there are already many excellent articles on this, I won't repeat it here. You can refer to [Quantitative Café's Instagram post](https://www.instagram.com/p/Co2cgyOJS8V).
...
Tables 4 and 5 respectively record the differences in the average TDS and extraction yield between the two experimental groups (NL-5min & NL-30min) and the control group.
