...
tag: [台大咖啡社, recipe]
category: article
# image: /assets/images/ntu_coffee_week_menu_1.png
...
<div class="row justify-content-center">
    <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
        <img width="2818" height="3760" src="/assets/images/ntu_coffee_week.webp" alt="" class="img-fluid responsive-image-vertical" style="border:1px black solid;">
...
<div class="row justify-content-center">
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img width="1240" height="1754" src="/assets/images/ntu_coffee_week_menu_1.png" style="width: 100%; border:1px black solid; height: auto;">
    </div>
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img width="1240" height="1754" src="/assets/images/ntu_coffee_week_menu_2.png" style="width: 100%; border:1px black solid; height: auto;">
    </div>
</div>

<div class="row justify-content-center">
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img width="1240" height="1754" src="/assets/images/ntu_coffee_week_menu_3.png" style="width: 100%; border:1px black solid; height: auto;">
    </div>
    <div class="col-md-6 mt-md-4 mt-3 text-center">
        <img width="1240" height="1754" src="/assets/images/ntu_coffee_week_menu_4.png" style="width: 100%; border:1px black solid; height: auto;">
    </div>
</div>
...
- 佈水器：[Tricolate](https://tricolate.com/)
    ...
    <div class="row justify-content-center">
            <div class="col-md-12 mt-md-4 mt-3 mb-md-4 mb-3 text-center">
                <img width="2874" height="3831" src="/assets/images/disperser_on_kono.webp" alt="" class="img-fluid responsive-image-vertical">
