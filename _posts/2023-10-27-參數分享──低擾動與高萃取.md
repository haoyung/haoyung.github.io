...
-   極淺烘焙的咖啡：因為我們的目標是極高的萃取率，因此需要確保咖啡在高萃取率的設定下本來就是好喝的，在我的經驗中這通常代表咖啡烘焙得極淺。
    -   一些實驗過並有好結果的店家：[SEY](sey.coffee)、[Manhattan](https://manhattancoffeeroasters.com/)、[Prodigal](https://getprodigal.com/)
...
7.   於 1:00 時，注入 70g 的水，一開始水量稍大，使水可以均勻分布在分水器內，接著以 2.5–3g/s 的速率於中心注水。
8.   輕輕搖晃濾杯（也就是做 Rao spin），使粉面平坦。
9.   於粉面上方水量約剩下 0.5cm 時，再次注入 70g 的水，並重複 7.–8.。重複四次後秤上顯示的總重應為 370g，代表總用水量為 320g（因為分水器重 50g）。
10.   等待水完全流乾，總沖煮時間約為 6–8 分鐘，但通常只要總時間在 10 分鐘內風味上都不會有太大的問題。
11.   使用 [Lotus Coffee Water](https://lotuscoffeeproducts.com/) 進行 Re-mineralize，在咖啡中滴入 CaCl<sub>2</sub> 溶液、MgCl<sub>2</sub> 溶液各一滴，NaHCO<sub>3</sub> 溶液兩滴，此時 Ca<sup>2+</sup>, Mg<sup>2+</sup>, HCO<sub>3</sub><sup>-</sup> 均約為 20 ppm as CaCO<sub>3</sub> 。
...
這個參數極為穩定，是我所使用的高萃取率參數中成功率最高的，極低的擾動使 clogging 的機率大減，但極細的研磨依然能支撐起極高的萃取率，且口感相當乾淨，幾乎有種透明的感覺。
