...
<div class="row mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <span class="image-span">表八、表九：在兩次實驗中，三台 Difluid 所測量 refractive index 的平均值及標準差，以及其各自與理論值之誤差</span>
    </div>
</div>
...
<div class="row mb-md-5 mb-4 justify-content-center text-center">
    <div class="col-md-12">
        <span class="image-span">表十、表十一：在兩次實驗中，三台 Difluid 所測量的 TDS 平均值及標準差，以及其各自與理論值之誤差</span>
    </div>
</div>
